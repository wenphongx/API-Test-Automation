...
public class Put_API_UpdateUser extends BaseTest {
    ...
    @Test(priority = 1, description = "Test Update Existing User")
    public void testUpdateExistingUser() {
        int newUserId = API_Utils.createUser(TOKEN);
        Map<String, Object> updatedData = new HashMap<>();
        updatedData.put("name", testData.get("name").asText());
        updatedData.put("status", testData.get("status").asText());

        API_Utils.updateUser(newUserId, updatedData, 200, TOKEN);
    }

    @Test(priority = 2, description = "Test Update Non-Existing User")
    ...
    @Test(priority = 3, description = "Test Update User Without Token")
    public void testUpdateUserWithoutToken() {
        ...
        API_Utils.updateUser(existingUserId, updatedData, 404, "");
    }

    @Test(priority = 4, description = "Test Update User With Invalid Token")
    ...
    @Test(priority = 5, description = "Test Update User With Invalid Status")
    public void testUpdateUserInvalidStatus() {
        ...
        API_Utils.updateUser(existingUserId, updatedData, 404, TOKEN);
    }

    @Test(priority = 6, description = "Test Update User With Invalid Gender")
